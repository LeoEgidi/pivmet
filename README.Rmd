...
- initialize the K-means algorithm $\rightarrow$ **pivotal seeding** (Egidi et al. 2018b)
...
Egidi, L., Pappada, R., Pauli, F. and Torelli, N. (2018a). Relabelling in Bayesian Mixture Models by Pivotal Units. Statistics and Computing, 28(4), 957-969.
