...
\item[\code{\code{final\_it\_p}}] \code{final\_it/nMC}
...
\item[\code{\code{mu\_rel}}] \code{final\_it x k} matrix (in case of univariate mixtures)
or \code{final\_it x 2 x k} array (in case of bivariate mixtures)
